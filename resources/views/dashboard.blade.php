<x-app-layout>
    ...
    <x-slot name='main'>
        <main class="py-12  w-full flex flex-row">
            <div class="w-full mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="grid text-center grid-cols-2 md:grid-cols-4 gap-3 justify-center">
                            <!-- Start Card 1 -->
                            <div class=" w-auto flex-auto md:flex-initial px-4 md:px-4 items-center relative flex rounded-xl duration-300 ease-in-out hover:shadow-2xl hover:ring-2 hover:ring-primary-500 hover:ring-offset-2 hover:ring-offset-white md:gap-x-3 md:rounded-2x md:p-3 border-2 h-[100px] z-20">
                                <div class="p-4 bg-blue-400 rounded-lg"><svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-white" fill="none"
