        ...
        @auth
            <div class="w-full">
                <button type="submit" id="button-beli" 
                    class="bg-sky-700 text-white focus:bg-sky-500 hover:bg-sky-500 focus:outline-none w-full py-2 md:rounded-2xl rounded-lg text-base md:text-lg focus:text-sky-700 transition-all duration-200 px-6 mx-auto items-center"  >
