        ...
        <div id="menu" class="flex flex-col space-y-2 overflow-x-hidden px-4 md:px-6">
            ...
            <div class="w-full relative" x-data="{ expanded: false }">
                <button @click="expanded = ! expanded"
                    ...
                    class="w-full flex justify-between text-start text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out hover:shadow-xl hover:shadow-teal-500/50 ">
                    <div>
                    ...
                    <div>
                        {{-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="2"
                            ...
                            :class="expanded === false ? 'rotate-180' : ''">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg> --}}

                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"  class="size-5 shrink-0 transition" aria-hidden="true"
                        :class="expanded === false ? 'rotate-180' : ''"><path d="M201.4 374.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 306.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>                     
                    </div>
                </button>
