<div class="mx-auto  w-full md:w-1/3 flex-1 space-y-6 md:top-24 lg:mt-0 md:sticky shadow-lg">
    <div
        ...
        <form action="{{ route('checkout.payment', $items->uuid) }}" method="POST" x-data="{ selected: false }">
            @csrf
            <div class="space-y-4">
                <div class="space-y-2">
                    ...
                    <dl class="flex items-center justify-between gap-4">
                        ...
                        <dd class="text-base font-medium  dark:text-white">Rp.
                            {{ number_format($items->price, 0, ',', '.') }}</dd>
                    </dl>
                ...
                <dl class="flex items-center justify-between gap-4">
                    <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Fee Admin</dt>
                    <dd class="text-base font-medium dark:text-white" ></dd>
                </dl>
                    ...
                    <dl class="flex items-center justify-between gap-4">
                        ...
                        <dd class="text-base font-medium  dark:text-white">Rp. 1.000</dd>
                    </dl>
                ...
                <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                    ...
                    <dd class="text-base font-bold  dark:text-white">Rp.
                        {{ number_format($items->gross_amount, 0, ',', '.') }}</dd>
                </dl>
            ...
            <div class="space-y-6 pt-4">
                <h2 class="text-lg font-semibold sm:text-xl ">Metode Pembayaran</h2>
                @include('includes.checkout.payment-gateway')
            </div>

            <button type="submit"
                class="flex w-full items-center justify-center rounded-lg px-5 py-2.5 text-sm font-medium text-white focus:outline-none focus:ring-4"
                :class="selected ?
                    'bg-orange-500 hover:bg-orange-700 focus:ring-orange-300 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800' :
                    'bg-gray-500 cursor-not-allowed'"
                :disabled="!selected">Bayar</button>
        </form>
