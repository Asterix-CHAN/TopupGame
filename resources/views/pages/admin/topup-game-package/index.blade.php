                        ...
                        <div class="py-2 inline-block w-full sm:px-6 lg:px-8">
                            ...
                            <div class="col-lg-12 mb-4 flex justify-end">
                                ...
                                <x-secondary-button x-data=""
                                    x-on:click.prevent="$dispatch('open-modal', 'modal-create-game')" name="">
                            ...
                            <div
                                class="overflow-x-auto shadow-md sm:rounded-lg border-collapse border border-slate-400">
                                            ...
                                            <tr>
                                                ...
                                                <td scope="col"
                                                    ...
                                                    @forelse ($item->categories as $category)
                                                        <span
                                                            class="p-[3px] bg-slate-600 rounded-md font-semibold text-white">{{ $category->name }}</span>
                                                    @empty
