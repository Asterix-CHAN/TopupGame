                    ...
                    <form action="{{ route('checkout.process', $item->uuid) }}" method="POST" id="shipping-detail">
                        ...
                        <div class="grid text-center grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 justify-center ">
                            ...
                            @forelse ($events as $event)
                                <div data-price="{{ $event->price }}" data-topup="{{ $event->diamond->diamond }}"
                                    id="btn-buy-1"
                                    ...
                                    <div
                                        ...
                                        <h4
                                            class=" text-xs xl:text-md font-medium  md:text-base text-ellipsis overflow-hidden">
                        ...
                        <div class="grid text-center grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-2 justify-center">
                            ...
                            <div data-price="Rp 27.000" data-topup="x1 Weekly Diamond Pass (Misi Top Up + 100)"
                                id="btn-buy-2"
                                ...
                                <label for="event{{ $event->id }}"
                                    ...
                                    <div
                                        ...
                                        <h4 class="text-sm font-semibold md:text-base text-ellipsis overflow-hidden">
                                            {{ $event->diamond->diamond }} Diamond
                                        </h4>
                                        <p class="text-xs md:text-sm text-ellipsis overflow-hidden">Rp
                                            {{ number_format($event->diamond->price, 0, ',', '.') }}
                                        </p>
                                    </div>
                                </label>
                            @empty
