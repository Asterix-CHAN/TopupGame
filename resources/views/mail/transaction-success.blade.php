    ...
    <div style="background-color:#E4E6EB;">
        ...
        <div style="background:white;background-color:white;margin:0px auto;max-width:600px;">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tbody>
                    <tr>
                        <td
                            style="border-bottom:1px dashed #eee;direction:ltr;font-size:0px;padding:0px;text-align:center;">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:24px;font-weight:bold;line-height:1;text-align:center;color:#071C4D;">
                                                Verifikasi Pembayaran Anda!</div>
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                    <tbody>
                                        <tr>
                                            <td
                                                style="border-bottom:1px dashed #eee;vertical-align:top;padding:0px 25px 30px;">
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                                border="0"
                                                                style="color:#071C4D;font-family:Assistant, Poppins, Helvetica;font-size:15px;line-height:22px;table-layout:auto;width:100%;border:none;">
                                                                <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:0px 25px;word-break:break-word;">
                                            ...
                                            <div
                                                style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071C4D;">
                                                Butuh Bantuan?</div>
        ...
        <div style="background:white;background-color:white;margin:0px auto;max-width:600px;">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tbody>
                    <tr>
                        <td style="direction:ltr;font-size:0px;padding:0px 25px 20px;text-align:center;">
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                ...
                                                <tr>
                                                    <td style="width: 50px;">
                                                        <img src="https://upload.wikimedia.org/wikipedia/commons/1/11/Logo_BUMN_Untuk_Indonesia_2020.svg"
                                                            width="50px" />
                                                    </td>
                                                    <td
                                                        style="font-size: 15px; color: #071C4D; font-family: Assistant, Helvetica;">
        ...
        <div style="margin:0px auto;max-width:600px;">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                <tbody>
                    <tr>
                        <td style="direction:ltr;font-size:0px;padding:30px 0 3px;text-align:center;">
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                ...
                                                2024 TeamCHAN Copyright All Rights Reserved.</div>
